package com.fbRegistrationPage;
...
public class Fb_RegistrationPage {

	WebDriver driver;

	public Fb_RegistrationPage(WebDriver driver) {
		super();
		this.driver = driver;
	...
	private WebElement Remobilenuber;

	public WebElement getmoREbileNumber(String remobilenumber) throws InterruptedException {
		Thread.sleep(5000);
		Remobilenuber.sendKeys(remobilenumber);
		return mobilenuber;
	}
